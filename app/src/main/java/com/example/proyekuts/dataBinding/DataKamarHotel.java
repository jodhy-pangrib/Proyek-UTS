...
public class DataKamarHotel {
    ...
    public static final DataHotel Suite         = new DataHotel("Suite Room","Include all facility for Deluxe Room", "2 Living Rooms, Work Office", "Mini Kitchen", "For 1 Night, Inculde Task", 2500000,"https://avenzelhotel.com/wp-content/uploads/2016/03/suite-bedroom-king.jpg");
